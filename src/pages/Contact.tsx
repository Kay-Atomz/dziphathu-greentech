                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+27711687921" className="text-lg font-medium hover:text-forest-500  text-forest-100 transition-colors">
                          +27 71 168 7921
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@dziphathugreentech.co.za" className="text-lg font-medium hover:text-forest-500 text-forest-100 transition-colors break-all">
                ...
                {/* <div className="bg-neutral-50 rounded-2xl p-4 ">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <a
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 rounded-lg  text-neutral-700 hover:border-primary-300 hover:text-primary-700 transition-colors"
                    >
